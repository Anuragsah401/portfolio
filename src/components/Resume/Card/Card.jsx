...
const Card = (props) => {
    ...
    return (
        <div className={`flex p-[3rem] hover:shadow-xl hover:shadow-cyan-500/50 transition ease delay-10 bg-[#ffffff] gap-[1rem] mt-[30px] rounded-[10px] relative ${before} ${after}`} key={props.index}>
            <div>
